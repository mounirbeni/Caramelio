document.addEventListener('DOMContentLoaded', () => {
  ...
  const revealTargets = document.querySelectorAll(
    '.page-header, .reserve-info, .reserve-card, .about-text, .about-visual, .hub-card, .highlight-card, .home-cta-inner, .dish-list, .dish-col, .menu-category-cover, .gallery-item, .bakery-text, .bakery-visual, .badge, .check-list li, .rating-card, .review-card, .location-info, .location-map, .info-row'
  );
